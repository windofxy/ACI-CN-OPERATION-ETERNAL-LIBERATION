...
echo [2/9] Applying RPCS3 tree transparency patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [3/9] Applying RPCS3 NP LocalNetInfo byte order fix patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [4/9] Applying RPCS3 P2PS disconnect fix patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [5/9] Applying RPCS3 freeze-tracer diagnostics patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [6/9] Applying RPCS3 lv2 cond-tracer diagnostics patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [7/9] Applying RPCS3 frame limit lock patch...
cd /d "%SRC%GIT\rpcs3"
...
echo [8/9] Applying RPCS3 RPCN disconnect fix patch...
cd /d "%SRC%GIT\rpcs3"
