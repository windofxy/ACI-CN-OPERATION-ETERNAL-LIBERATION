...
Apply-Patch "SRC\GIT\rpcs3" "$RepoRoot\SRC\PATCH\RPCS3\rpcn-roomdata-notfound-fix.patch"
Apply-Patch "SRC\GIT\rpcs3" "$RepoRoot\SRC\PATCH\RPCS3\rpcn-reconnect.patch"
